...
이 리포지토리의 `0305` 폴더에는 OpenCV를 사용한 세 가지 예제 스크립트가 포함되어 있습니다. 각 스크립트는 전체 코드와 요구사항을 만족하는 핵심 기능 코드(요약)를 함께 제공합니다.
...
**사용법 요약**
- 각 스크립트는 터미널에서 다음처럼 실행합니다:

```bash
python 0305/0305-1.py
python 0305/0305-2.py
python 0305/0305-3.py
```

비디오/이미지 창에서 지원되는 키는 각 스크립트 설명 섹션에 기재되어 있습니다.
